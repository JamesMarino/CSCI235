...
INSERT INTO EMPLOYEE (E#, Name, D#) VALUES (
  '1',
  'Albert',
  6
);
...
/*
ALTER TABLE PROJECT MODIFY PTITLE VARCHAR2(50);
*/
...
UPDATE DEPARTMENT SET TOTAL_STAFF_NUMBER = (SELECT COUNT(*) FROM EMPLOYEE WHERE EMPLOYEE.D# = DEPARTMENT.D#);
*/
...
SELECT DName FROM DEPARTMENT WHERE D# = &DEPARTMENT_NUMBER;

-- Get Projects
SELECT COUNT(*) FROM PROJECT JOIN DEPARTMENT ON PROJECT.D# = DEPARTMENT.D#;
*/
...
ACCEPT PROJECT_SPONSER PROMPT 'Please enter a sponser: ';
